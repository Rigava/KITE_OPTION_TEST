...
if len(strike_df_ce) > 0:
    ...
    fig1 = go.Figure()
    fig1.add_trace(go.Scatter(x=strike_df_ce["Datetime"], y=strike_df_ce["Close"], name="Price ATM CE"))
    fig1.add_trace(go.Scatter(x=strike_df_pe["Datetime"], y=strike_df_pe["Close"], name="Price ATM PE"))
